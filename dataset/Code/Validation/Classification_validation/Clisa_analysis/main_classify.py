...
if n_vids == 24:
    save_dir = './runs_srt/raw_24video_batch24_dataset_%s_timeLen5_tf16_sf16_multiFact2_lr0.000700_wd0.015000_epochs80_randSeed%d_fold10_accSel_newPre_cls2' % (args.dataset, args.randSeed)
elif n_vids == 28:
    save_dir = './runs_srt/raw_28video_batch28_dataset_%s_timeLen5_tf16_sf16_multiFact2_lr0.000700_wd0.015000_epochs80_randSeed7_fold10_accSel_newPre_%s'% (args.dataset, label_type)
...
if finetune:
    ...
    for base_long in [60]:
        ...
        for fold in range(n_folds):
            ...
            for iter in iteration:
                ...
                if train_or_test == 'train':
                    ...
                    scheduler = torch.optim.lr_scheduler.StepLR(optimizer, step_size=args.epochs_finetune, gamma=0.8,
                    ...
                    results_finetune['train_acc_history'][current_val, :], results_finetune['val_acc_history'][current_val,
                    ...
                    best_epoch_file = os.path.join(save_dir_ft, val_method + '_' + args.dataset + '_dataset_results_finetune.pkl')
                    ...
                    state_dict = os.path.join(save_dir_ft, str(fold), 'finetune_checkpoint_00%s.pth.tar' % (best_epoch))
                    ...
                    for sub in val_sub:
                        ...
                        subjects_score[sub] = np.mean([np.sum(subjects_results[sub, vid, :] == label_repeat[vid, :]) /
        ...
        if train_or_test == 'test':
            ...
            with open(os.path.join(save_dir_ft, val_method + '_' + args.dataset + '_dataset_results_finetune.pkl'), 'wb') as f:
                pickle.dump(results_finetune, f)
