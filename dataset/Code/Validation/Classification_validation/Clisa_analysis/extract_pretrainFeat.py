...
if args.use_data == 'pretrained':
    ...
    if label_type == 'cls2':
        save_dir = data_dir + 'runs_srt/raw_24video_batch24_dataset_%s_timeLen5_tf16_sf16_multiFact2_lr0.000700_wd0.015000_epochs80_randSeed%d_fold10_accSel_newPre_%s' % (
